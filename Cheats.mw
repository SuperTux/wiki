...
* For Windows users, create a shortcut to supertux.exe, and edit the properties of the shortcut to include --debug-mode at the end of the "Target" box. ( "C:\Program Files\SuperTux\supertux.exe" --debug-mode )<br />Or just run it from a command prompt.

== SuperTux 0.3 ==

Cheat codes got replaced by [[Console]] commands.
