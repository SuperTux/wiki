...
: Of the presented alternatives I prefer firehat. The MS1 one is uggly, and I have not seen that one with a headband, any link to that image? --[[User:AnMaster|AnMaster]] 23:17, 13 June 2007 (UTC)

'''Grumbel's concept art:''' Tux wears a dragon suit.
: I like the dragon suit. The fireball's behaviour is okay; it could be tweaked a bit, but it's not that important - I couldn't tell how to do it better. [[User:Wansti|Wansti]]

'''Fan concept:''' Tux wears a headband.

: I don't care much what we end up with, as long as it is not a fireman's hat or anything else that relates to the real world. We might also drop fireflower completly or change its behaviour a lot, no need to staying to close to Mario on that one. -- [[User:Grumbel|Grumbel]] 03:33, 14 June 2007 (UTC)
:: I'd hate it if we dropped the fireflower. I think it has a purpose, I think it fulfills that purpose and I think it should be here to stay. We should rather tweak or drop the iceflower. <nowiki>~~</nowiki>[[User:RavuAlHemio|Ravu]] 10:56, 24 June 2007 (UTC)
...
: Of the presented alternatives I prefer this but it isn't very good either, maybe a mix of this and tuxdev's concept? --[[User:AnMaster|AnMaster]] 23:17, 13 June 2007 (UTC)
...
: Run should be automatic, with proper acceleration. If all fails we can fall back to the run key, but we should never have a walk-key. -- [[User:Grumbel|Grumbel]] 03:29, 14 June 2007 (UTC)
:: Well, if we're constantly running without a chance of reverting back to slow walking, the player's precision of control decreases strongly. This makes some of the gameplay's more challenging elements too challenging. I'd say the behaviour ''with'' a walk key isn't that bad. <nowiki>~~</nowiki>[[User:RavuAlHemio|Ravu]] 10:56, 24 June 2007 (UTC)

== Up and Jump ==
'''What's in MS1:''' Jump is the up arrow key by default, there is no use of an Up key.
: Of the presented alternatives I prefer this. But up key is useful to, we need it, but I can't stand jump on space. My keyboard can't handle that while also running. Space + arrow + ctrl = too much. So for me this is the only way. --[[User:AnMaster|AnMaster]] 23:17, 13 June 2007 (UTC)
...
: In my opinion: YES. --[[User:AnMaster|AnMaster]] 23:17, 13 June 2007 (UTC)

: Yes, no point in arguing, this has to be fixed. Only thing to keep in mind is that we might get trouble with using Up-key for entering doors. -- [[User:Grumbel|Grumbel]]

: No.  There are multiple reasons why the up arrow key should not be jump.  Up is used to enter doors.  Up would be used to peek upwards, if any peeking was done at all.  Up is used to throw objects upward.  The engine and design of the game has progressed to the point that the up arrow key can't reasonably be used to jump anymore, and hacking it to work anyway is wrong. [[User:Tuxdev|Tuxdev]] 13:45, 14 June 2007 (UTC)

: No. I've had my fun with a few GameBoy jump-'n'-runs a few years ago, and I always jumped using A, entering doors with &#8593;. Even back in MS1, I jumped with the spacebar. I have no problems placing both hands on my keyboard and I bet the majority of our audience has no severed fingers. (And those who have will probably have special input appliances anyway.) <nowiki>~~</nowiki>[[User:RavuAlHemio|Ravu]] 10:47, 24 June 2007 (UTC)

: I'd say no, but that is really a matter of taste. So why don't we let the users decide individually by offering both options? [[User:Wansti|Wansti]]
