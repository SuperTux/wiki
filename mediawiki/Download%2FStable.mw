...
There's a package available here:
 http://distro.ibiblio.org/pub/linux/distributions/amigolinux/download/Applications/Games/supertux-0.1.3/supertux-0.1.3-i486-1.tgz
...
Note: if you have created packages for other operating systems/distributions. Mention them in the [http://supertux.lethargik.org/wiki/index.php?title=Talk:Download/Installation_Milestone_1&action=edit discussion page] and we'll merge them into this page as soon as possible.
