There are known bugs in older releases. See [[Bugs]] for newer versions.

== Website ==

* The titlebar of the browser in this wiki shows "Wikipedia" instead of "SuperTux" when logged in.
*:Can't reproduce that problem. Works fine here. --[[User:WolfgangB|WolfgangB]] 00:30, 15 Sep 2006 (BST)
*:: I've sometimes noticed with certain sites that exiting a tab (in Firefox) will not update the titlebar. Right now the CSS on the wiki is messed up for me, but I know it is just me. --[[User:Tuxdev|Tuxdev]] 00:48, 15 Sep 2006 (BST)
*:::It's still there. I'm using Opera 9 on Ubuntu Dapper
*:::: So am I, but I don't experience anything like it. Maybe a custom skin? Can you give steps to reproduce? --[[User:84.146.251.243|84.146.251.243]] 14:02, 29 Oct 2006 (CET)
...
*::::::Well I see SuperTux when I login. '''Nowhere''' does it say Wikipedia. Can you please tell where exactly you see Wikipedia on any page? --[[User:AnMaster|AnMaster]] 20:35, 3 Nov 2006 (CET)
*: Probably because you set the Wiki to output non-english content. Wikimedia comes in 86 different languages and SuperTux-specific strings were only added for some of them. The Wiki now forces an english locale for all users until we have localizations for the rest of the supported languages. --[[User:Sommer|Sommer]] 13:50, 4 Nov 2006 (CET)
...
*: You might be experiencing a new feature of ST engine, unisolid tiles. Example level is "Detour", for the tree branches. --[[User:Tuxdev|Tuxdev]] 18:11, 20 Dec 2006 (CET)
...
*: This is a general problem when badguys stack - it always looks a bit out of place. SuperTux might be better off either letting badguys walk through each other or having badguys get squished when another badguy steps on their head. --[[User:131.188.73.150|131.188.73.150]] 14:08, 26 Sep 2006 (BST)
...
* 4162: Error in drawing of tilemap-to-lightmap on Windows. Doesn't happen on Linux. See [[:Image:Lightmap_error_on_Windows.png|screenshot]] for details.
...
:::Seems to go away with #define LIGHTMAP_DIV 5 instead of 4 (light lines) or 1 (too slow on some machines)
...
* 4249: Squirrel function wait() counts real seconds, not game seconds - so cutscenes can end up deadly for Tux of time synchronisation doesn't fit. -- [[User:Penma|Penguinmaster]] 23:42, 30 Sep 2006 (CEST)

* 4327: Forest worldmap has a level off the path, and says that "tilemap data is buggy" when I get near it.--[[User:Djwings|DJ Wings]][[User_talk:Djwings|<sub>Freesyle here</sub>]] 15:34, 1 Oct 2006 (CEST)
...
*: Fixed in SVN --[[User:Sommer|Sommer]] 22:21, 2 Jan 2007 (CET)
...
*: Now it is --[[User:Sommer|Sommer]] 22:21, 2 Jan 2007 (CET)
...
*: I don't think that's SuperTux' fault --[[User:Sommer|Sommer]] 22:21, 2 Jan 2007 (CET)
...
*: Intended behaviour --[[User:Sommer|Sommer]] 22:21, 2 Jan 2007 (CET)
...
*: Fixed --[[User:Sommer|Sommer]] 23:15, 8 Jan 2007 (CET)
...
*: This also happens to me using the NVIDIA drivers. Either this is a off-by-one error in SuperTux that happens to be negated by a similar bug in the ATI drivers, or is a bug in the open source and NVIDIA drivers that is exposed by SuperTux. --[[User:Tuxdev|Tuxdev]] 05:46, 27 Dec 2006 (CET)
...
*: Level statistics are currently not saved to disk --[[User:Sommer|Sommer]] 22:21, 2 Jan 2007 (CET)
*: Also, no statistics are available when you use a checkpoint after getting killed in a level --[[User:Sommer|Sommer]] 22:21, 2 Jan 2007 (CET)
...
*: Did you try manually running the package installer? To do so, open a command line window, change to the directory you downloaded the file supertux-0.3.0b.x86.package to (e.g. "cd ~/Desktop"), then either run "~/.local/bin/package install supertux-0.3.0b.x86.package" or "package install supertux-0.3.0b.x86.package", depending on where you installed autopackage. --[[User:Sommer|Sommer]] 23:03, 8 Jan 2007 (CET)
...
*: Solved by upgrading to Dapper. --[[User:Djwings|DJ Wings]][[User_talk:Djwings|<sub>Freesyle here</sub>]] 16:40, 24 Sep 2006 (BST)
