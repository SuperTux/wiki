...
* If you'd like an easy way to launch SuperTux via Finder but would rather use [[User:RavuAlHemio|Ravu al Hemio's]] build, then take a look at [[Building on Mac OS X#.command File|making a .command file]].
...
* The [[Download/Stable#Mac_OS_X|stable]] (0.1.3) and [[Download/Unstable|unstable]] (0.3.0) versions of SuperTux built for OS X have a supertux.icns file under "SuperTux.app/Contents/Resources/" that you can use for the "Icon File". You'll have to add it to the XCode project first before you can set it here.
...
* You can download the latest binary (SVN <nowiki>revision</nowiki> 5105) [http://supertux.lethargik.org/users/glowingapple/SuperTux-SVN-&#114;5105.dmg here] ([http://supertux.lethargik.org/users/glowingapple/SuperTux-SVN-&#114;5105.dmg.md5sum md5sum]: 856f5e0320d25ef4d232ebe530f9673d).
* If the above version fails to run, you can try an older revision (SVN <nowiki>revision</nowiki> 5087) from [http://supertux.lethargik.org/users/glowingapple/SuperTux-SVN-&#114;5087.dmg here] ([http://supertux.lethargik.org/users/glowingapple/SuperTux-SVN-&#114;5087.dmg.md5sum md5sum]: b2b3e21032211c8eec2ceb8647b3ff65).
