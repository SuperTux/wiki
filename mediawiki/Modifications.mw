"Modifications" are defined as files that replace game content rather than adding on to it. New code is generally a mod (SuperTux isn't extensible yet), as well as most sounds, but most levels and graphics are just contributions.
...
Note that these tiles, levels to use them, new added features, and more are already available in the [[Download/Unstable|unstable package]].

== SuperTux SVN ==

=== supertux-nogl ===

This is a patch for running the game on systems without OpenGL support. Also in the [[Download/Unstable|unstable package]].
...
A game made to look like a "3D mod" of SuperTux.
Under Development.
