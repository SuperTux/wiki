...
=== [http://moleinvasion.tuxfamily.org MoleInvasion] ===

An open source jump and run game. Seems to be heavily inspired by SuperTux and Pingus.

=== [http://www.miraigamer.net/cavestory/ Cave Story/Doukutsu] ===

Brilliant freeware jump and shoot. Featuring very polished music, story, atmosphere. Also shows how good jump and run physics should look like... A Linux version can be found at [http://community.livejournal.com/doukutsu/101690.html]
...
A Live CD featuring SuperTux Mi1.9. [http://stl.rexburgopensource.com/supertux-live-1.0.iso Final release] with [http://stl.rexburgopensource.com/supertux-live-1.0.iso.md5sum md5 checksum] Previous release: [http://downloads.rexburgopensource.com/supertuxlive/supertux-live-0.91.2.iso Beta 2]
Thanks to Joseph Brower from the Rexburg Idaho Open Source Users Group for hosting!

=== SuperTux 0.3.3 addon collection ===
A [http://www.mediafire.com/?k47v61nz6i230 collection of addons] made for development snapshot 0.3.3 and 0.3.3-SVN.  Mostly player-made levels submitted to the bugtracker but have yet to be implemented.  Note that these levels are for the development version and may even have compatibility issues between the snapshot and the various revisions of SVN.  Please pay attention to the intended version and keep in mind that they are unofficial addons and not maintained by the development team.  This collection is maintained by [[User:LMH|lmh]].
