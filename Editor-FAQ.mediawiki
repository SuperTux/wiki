...
show your level, and if you stick around for a few minutes (it takes a little while to get noticed), 
...
# From source through [[Download/Subversion|Subversion]].
...
[[Image:Sequencetrigger.png|left]] The SequenceTrigger object is used to define the areas that start and stop the end sequence (Tux walks into Igloo / Exit). The sequence names for that are "endsequence" and "stoptux", respectively. Also, you can use "fireworks".
...
[[Image:Scripttrigger.png]] The script object is used to define an occurrence which will happen when Tux enters the
...
[[Image:EditorBrushIcon.png|left]]
