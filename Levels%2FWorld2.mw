...
* Sometimes a bit too many [[Zeekling]]s at the same time.
...
Difficulty:
::easy/medium. Can be completed in <2min.--[[User:WolfgangB|WolfgangB]] 00:57, 7 Jul 2006 (BST)
...
Update r3937. Longer, more coin trails. --[[User:WolfgangB|WolfgangB]] 03:13, 8 Jul 2006 (BST)

Update r4039: Two more signs right at the beginning to avoid the dead end. --[[User:WolfgangB|WolfgangB]] 18:18, 17 Jul 2006 (BST)
...
Uses switches to block/unblock passageways with column-like platforms, questionable usage at best. Extremely large and empty, distances between relevant objects could be shrunk. (Half the time spent in the level is walking back and forth) Spike pit is a bit large. One part requires Tux to jump off blindly, drop into a pit of lava, then lifts him out of the lava with platforms to allow Tux to continue - very disconcerting. The secret path is also odd, as it flips Tux, requires him to ride a platform across the level, passing over the parts he just went through, and then the flip-back area is too small and requires Tux to jump up to activate it. --[[User:Mathnerd314|Mathnerd314]] 00:39, 23 February 2008 (UTC)

== dfk-level3.stl ==
Having entered Nolok's castle at the bottom, Tux must now climb up to face him at the top.
Status: Playable, although there are some ''very'' tight jumps in places (Take a running jump and stop on a two-tile platform, then do another running jump off that. Later, Tux gets to take a running jump up, go through a 1-tile gap between the ceiling and a bracket, and come back down 4 tiles later). Missing all its badguys.
There are a few dead ends, but those are recoverable as Tux can fall back down.

Difficulty: Very hard, but only requires skilled handling of Tux and a working knowledge of the level. Adding badguys will make it either impossible or improbable to beat, depending on how they are placed. --[[User:Mathnerd314|Mathnerd314]] 00:39, 23 February 2008 (UTC)
...
Contains an Angrystone and very odd-looking tilesets as well which can only be accessed by ghosting through the floor. --[[User:Mathnerd314|Mathnerd314]] 00:39, 23 February 2008 (UTC)
...
Update: extended in r3957. --[[User:WolfgangB|WolfgangB]] 19:52, 8 Jul 2006 (BST)

Update r4038: Main level is one sector again. Less badguys, removed dispenser, made some jumps simpler. --[[User:WolfgangB|WolfgangB]] 18:20, 17 Jul 2006 (BST)
...
Update: r3932 should fix most of the problems.--[[User:WolfgangB|WolfgangB]] 21:04, 7 Jul 2006 (BST)
...
* We might use this as an introductory level, but the first rock Tux encounters has to scream "carry me". Users already had difficulty interpreting the "Run" sign in Milestone 1, level 1, so let's make this absolutely clear :-) --[[User:Sommer|Sommer]] 10:35, 30 Jul 2006 (BST)
::I can add another rock near the start. If it's placed in midair it will drop down while the player is watching to make it clear that this rock is not a standard tile. If another sign next to the rock is not good enough we could mention it in the manual or add an infoblock. --[[User:WolfgangB|WolfgangB]] 15:29, 30 Jul 2006 (BST)
::Is something like [[Media:RockHowTo-nq8.png]] self explaining or does it need additional text? --[[User:WolfgangB|WolfgangB]] 17:05, 31 Jul 2006 (BST)
